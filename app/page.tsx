  ...
  <main>
    <section style={styles.hero}>
      <div style={{ ...styles.container, ...styles.heroGrid }}>
        <div>
          <h1 style={styles.heroTitle}>Reliable warehouse and lumper support for your daily operations.</h1>
    ...
    <section id="contact" style={styles.section}>
      <div style={{ ...styles.container, ...styles.contactWrap }}>
        ...
        <form action="https://formspree.io/f/maqlaorw" method="POST" style={styles.form}>
          ...
          <textarea name="message" placeholder="Location, service needed, volume" style={styles.textarea} />
